#https://github.com/plataformatec/simple_form/issues/1516#issuecomment-339642181
module SimpleFormBootstrap4
  module SimpleFormConfiguration
    def self.configure
      ...
      ::SimpleForm::Inputs::Base.prepend Module.new {
        def merge_wrapper_options(options, wrapper_options)
          if wrapper_options.is_a?(Hash) && wrapper_options.key?(:error_class)
